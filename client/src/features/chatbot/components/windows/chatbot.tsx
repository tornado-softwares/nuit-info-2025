...
export function ChatBotWindow() {
    const [messages, setMessages] = useState<Message[]>([
        { role: "assistant", content: "Qu'est-ce qu'il y a encore ? Pourquoi voulez-vous me parler ? Pourquoi avez-vous allumé cet ordinateur ?" },
    ])
    ...
    return <div className="flex flex-col w-full h-full">
        ...
        <div className="flex-1 flex sm:flex-row flex-col gap-2 bg-white border-black/40 border-x-3 p-2  overflow-y-auto">

            <div className="sm:w-1/3  bg-gray-100 border border-gray-400 flex sm:flex-col  flex-row  overflow-hidden relative ">
                <img
...
export function ChatBotWindowRnd() {
    return <Rnd
        default={{
            x: 100,
            y: 100,
